    ...
    <section className="py-10">
      <Container>
        ...
        <div className="pt-5 md:py-5 md:flex gap-5">
          <div className="flex-1 flex flex-col items-center mb-5 md:mb-0 px-5 py-10 border-2">
            ...
            <p className="text-center">
              ...
              have trainers with over 10 years of working, teaching and training
              experience.
            </p>
          ...
          <div className="flex-1 flex flex-col items-center mb-5 md:mb-0 px-5 py-10 border-2">
            ...
            <h3 className="my-3 font-bold capitalize">Flexible workout time</h3>
            <p className="text-center">
              Mike's gym has one of the best flexible workout time schedule. We
              provide fitness services for our members, base on their convinient
              time.
            </p>
            <span className="captalize underline cursor-pointer text-accent-500 ">
              Learn more
          ...
          <div className="flex-1 flex flex-col items-center mb-5 md:mb-0 px-5 py-10 border-2">
            ...
            <p className="text-center">
              ...
              services at cheap and discount prices. We also provide bonuses to
              our VIP members.
            </p>
            <span className="captalize underline cursor-pointer text-accent-500 ">
              Learn more
